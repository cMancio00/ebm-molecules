...
class WideResNet(nn.Module):
    def __init__(self, depth, widen_factor, n_outputs=10, input_channels=3,
        ...
        self.linear = nn.Linear(nStages[3], n_outputs)
...
# -optimizer adam --p_x_weight 1.0 --p_y_given_x_weight 1.0 --p_x_y_weight 0.0 --sigma .03 --width 10 --depth 28 --save_dir /YOUR/SAVE/DIR
# --plot_uncond --warmup_iters 100
class PaperJBMWideResNet(WideResNet):
    
    def __init__(self):
        super().__init__(depth=28, widen_factor=10, norm=None, dropout_rate=0, n_outputs=10)